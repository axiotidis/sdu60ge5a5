...
config = {
  "apiKey": "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",  #set the api key provided by google firebase
  "authDomain": "xxxxxxxxxxxx.firebaseapp.com",             #set the authDomain provided by google firebase
  "databaseURL": "https://xxxxxxxxxx.firebaseio.com",       #set the databaseURL provided by google firebase
  "storageBucket": "xxxxxxxxxxx.appspot.com"                 #set the storageBucket provided by google firebase
}
...
address = "localhost"
username = "xxxxxx"         #set the MySql username
password = "xxxxxxxx"       #set the MySql password
database = "xxxxxxxxx"      #set the MySql database name
